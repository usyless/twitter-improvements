        ...
        'Settings': {
            'Link Copying': [
                ...
                },
                {
                    ...
                    category: 'vx_preferences',
                    description: 'Embed Translation language',
                    type: 'choice',
                    choices: [ // List of languages and their language codes loosely based off ISO 639-1.
                        {name: 'None', type: ''},
                        ...
                        {name: 'Tajik', type: 'tg'},
                        {name: 'Thai', type: 'th'},
                        {name: 'Tigrinya', type: 'ti'},
                        {name: 'Tonga', type: 'to'},
                        {name: 'Turkish', type: 'tr'},
                        {name: 'Turkmen', type: 'tk'},
