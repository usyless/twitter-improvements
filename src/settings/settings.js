    ...
    const /** @type {Record<string, Record<string, option[]>>} */ options = {
        'Settings': {
            'Link Copying': [
                ...
                {
                    name: 'vx_append_translation',
                    category: 'vx_preferences',
                    description: 'Adds a country code of your choice as a suffix to the copied URL (e.g. "en" for English, "fr" for French, etc.)',
                    type: 'choice',
                    choices: [ // List of countries and their language codes based off ISO 639-1.
                        {name: 'None', type: ''},
                        {name: 'Afghanistan', type: 'ps'},
                        {name: 'Albania', type: 'sq'},
                        {name: 'Algeria', type: 'ar'},
                        {name: 'Andorra', type: 'ca'},
                        {name: 'Angola', type: 'pt'},
                        {name: 'Antigua and Barbuda', type: 'en'},
                        {name: 'Argentina', type: 'es'},
                        {name: 'Armenia', type: 'hy'},
                        {name: 'Australia', type: 'en'},
                        {name: 'Austria', type: 'de'},
                        {name: 'Azerbaijan', type: 'az'},
                        {name: 'Bahamas', type: 'en'},
                        {name: 'Bahrain', type: 'ar'},
                        {name: 'Bangladesh', type: 'bn'},
                        {name: 'Barbados', type: 'en'},
                        {name: 'Belarus', type: 'be'},
                        {name: 'Belgium', type: 'nl'},
                        {name: 'Belize', type: 'en'},
                        {name: 'Benin', type: 'fr'},
                        {name: 'Bhutan', type: 'dz'},
                        {name: 'Bolivia', type: 'es'},
                        {name: 'Bosnia and Herzegovina', type: 'bs'},
                        {name: 'Botswana', type: 'en'},
                        {name: 'Brazil', type: 'pt'},
                        {name: 'Brunei', type: 'ms'},
                        {name: 'Bulgaria', type: 'bg'},
                        {name: 'Burkina Faso', type: 'fr'},
                        {name: 'Burundi', type: 'fr'},
                        {name: 'Cabo Verde', type: 'pt'},
                        {name: 'Cambodia', type: 'km'},
                        {name: 'Cameroon', type: 'fr'},
                        {name: 'Canada', type: 'en'},
                        {name: 'Central African Republic', type: 'fr'},
                        {name: 'Chad', type: 'fr'},
                        {name: 'Chile', type: 'es'},
                        {name: 'China', type: 'zh'},
                        {name: 'Colombia', type: 'es'},
                        {name: 'Comoros', type: 'ar'},
                        {name: 'Costa Rica', type: 'es'},
                        {name: 'Côte d’Ivoire', type: 'fr'},
                        {name: 'Croatia', type: 'hr'},
                        {name: 'Cuba', type: 'es'},
                        {name: 'Cyprus', type: 'el'},
                        {name: 'Czechia', type: 'cs'},
                        {name: 'Democratic Republic of the Congo', type: 'fr'},
                        {name: 'Denmark', type: 'da'},
                        {name: 'Djibouti', type: 'fr'},
                        {name: 'Dominica', type: 'en'},
                        {name: 'Dominican Republic', type: 'es'},
                        {name: 'Ecuador', type: 'es'},
                        {name: 'Egypt', type: 'ar'},
                        {name: 'El Salvador', type: 'es'},
                        {name: 'Equatorial Guinea', type: 'es'},
                        {name: 'Eritrea', type: 'ti'},
                        {name: 'Estonia', type: 'et'},
                        {name: 'Eswatini', type: 'en'},
                        {name: 'Ethiopia', type: 'am'},
                        {name: 'Fiji', type: 'en'},
                        {name: 'Finland', type: 'fi'},
                        {name: 'France', type: 'fr'},
                        {name: 'Gabon', type: 'fr'},
                        {name: 'Gambia', type: 'en'},
                        {name: 'Georgia', type: 'ka'},
                        {name: 'Germany', type: 'de'},
                        {name: 'Ghana', type: 'en'},
                        {name: 'Greece', type: 'el'},
                        {name: 'Grenada', type: 'en'},
                        {name: 'Guatemala', type: 'es'},
                        {name: 'Guinea', type: 'fr'},
                        {name: 'Guinea-Bissau', type: 'pt'},
                        {name: 'Guyana', type: 'en'},
                        {name: 'Haiti', type: 'fr'},
                        {name: 'Honduras', type: 'es'},
                        {name: 'Hungary', type: 'hu'},
                        {name: 'Iceland', type: 'is'},
                        {name: 'India', type: 'hi'},
                        {name: 'Indonesia', type: 'id'},
                        {name: 'Iran', type: 'fa'},
                        {name: 'Iraq', type: 'ar'},
                        {name: 'Ireland', type: 'en'},
                        {name: 'Israel', type: 'he'},
                        {name: 'Italy', type: 'it'},
                        {name: 'Jamaica', type: 'en'},
                        {name: 'Japan', type: 'ja'},
                        {name: 'Jordan', type: 'ar'},
                        {name: 'Kazakhstan', type: 'kk'},
                        {name: 'Kenya', type: 'en'},
                        {name: 'Kiribati', type: 'en'},
                        {name: 'Kuwait', type: 'ar'},
                        {name: 'Kyrgyzstan', type: 'ky'},
                        {name: 'Laos', type: 'lo'},
                        {name: 'Latvia', type: 'lv'},
                        {name: 'Lebanon', type: 'ar'},
                        {name: 'Lesotho', type: 'en'},
                        {name: 'Liberia', type: 'en'},
                        {name: 'Libya', type: 'ar'},
                        {name: 'Liechtenstein', type: 'de'},
                        {name: 'Lithuania', type: 'lt'},
                        {name: 'Luxembourg', type: 'lb'},
                        {name: 'Madagascar', type: 'mg'},
                        {name: 'Malawi', type: 'en'},
                        {name: 'Malaysia', type: 'ms'},
                        {name: 'Maldives', type: 'dv'},
                        {name: 'Mali', type: 'fr'},
                        {name: 'Malta', type: 'mt'},
                        {name: 'Marshall Islands', type: 'en'},
                        {name: 'Mauritania', type: 'ar'},
                        {name: 'Mauritius', type: 'en'},
                        {name: 'Mexico', type: 'es'},
                        {name: 'Micronesia', type: 'en'},
                        {name: 'Moldova', type: 'ro'},
                        {name: 'Monaco', type: 'fr'},
                        {name: 'Mongolia', type: 'mn'},
                        {name: 'Montenegro', type: 'sr'},
                        {name: 'Morocco', type: 'ar'},
                        {name: 'Mozambique', type: 'pt'},
                        {name: 'Myanmar', type: 'my'},
                        {name: 'Namibia', type: 'en'},
                        {name: 'Nauru', type: 'en'},
                        {name: 'Nepal', type: 'ne'},
                        {name: 'Netherlands', type: 'nl'},
                        {name: 'New Zealand', type: 'en'},
                        {name: 'Nicaragua', type: 'es'},
                        {name: 'Niger', type: 'fr'},
                        {name: 'Nigeria', type: 'en'},
                        {name: 'North Korea', type: 'ko'},
                        {name: 'North Macedonia', type: 'mk'},
                        {name: 'Norway', type: 'no'},
                        {name: 'Oman', type: 'ar'},
                        {name: 'Pakistan', type: 'ur'},
                        {name: 'Palau', type: 'en'},
                        {name: 'Palestine', type: 'ar'},
                        {name: 'Panama', type: 'es'},
                        {name: 'Papua New Guinea', type: 'en'},
                        {name: 'Paraguay', type: 'es'},
                        {name: 'Peru', type: 'es'},
                        {name: 'Philippines', type: 'en'},
                        {name: 'Poland', type: 'pl'},
                        {name: 'Portugal', type: 'pt'},
                        {name: 'Qatar', type: 'ar'},
                        {name: 'Republic of the Congo', type: 'fr'},
                        {name: 'Romania', type: 'ro'},
                        {name: 'Russia', type: 'ru'},
                        {name: 'Rwanda', type: 'rw'},
                        {name: 'Saint Kitts and Nevis', type: 'en'},
                        {name: 'Saint Lucia', type: 'en'},
                        {name: 'Saint Vincent and the Grenadines', type: 'en'},
                        {name: 'Samoa', type: 'sm'},
                        {name: 'San Marino', type: 'it'},
                        {name: 'São Tomé and Príncipe', type: 'pt'},
                        {name: 'Saudi Arabia', type: 'ar'},
                        {name: 'Senegal', type: 'fr'},
                        {name: 'Serbia', type: 'sr'},
                        {name: 'Seychelles', type: 'fr'},
                        {name: 'Sierra Leone', type: 'en'},
                        {name: 'Singapore', type: 'en'},
                        {name: 'Slovakia', type: 'sk'},
                        {name: 'Slovenia', type: 'sl'},
                        {name: 'Solomon Islands', type: 'en'},
                        {name: 'Somalia', type: 'so'},
                        {name: 'South Africa', type: 'en'},
                        {name: 'South Korea', type: 'ko'},
                        {name: 'South Sudan', type: 'en'},
                        {name: 'Spain', type: 'es'},
                        {name: 'Sri Lanka', type: 'si'},
                        {name: 'Sudan', type: 'ar'},
                        {name: 'Suriname', type: 'nl'},
                        {name: 'Sweden', type: 'sv'},
                        {name: 'Switzerland', type: 'de'},
                        {name: 'Syria', type: 'ar'},
                        {name: 'Tajikistan', type: 'tg'},
                        {name: 'Tanzania', type: 'sw'},
                        {name: 'Thailand', type: 'th'},
                        {name: 'Timor-Leste', type: 'pt'},
                        {name: 'Togo', type: 'fr'},
                        {name: 'Tonga', type: 'to'},
                        {name: 'Trinidad and Tobago', type: 'en'},
                        {name: 'Tunisia', type: 'ar'},
                        {name: 'Türkiye', type: 'tr'},
                        {name: 'Turkmenistan', type: 'tk'},
                        {name: 'Tuvalu', type: 'en'},
                        {name: 'Uganda', type: 'en'},
                        {name: 'Ukraine', type: 'uk'},
                        {name: 'United Arab Emirates', type: 'ar'},
                        {name: 'United Kingdom', type: 'en'},
                        {name: 'United States', type: 'en'},
                        {name: 'Uruguay', type: 'es'},
                        {name: 'Uzbekistan', type: 'uz'},
                        {name: 'Vanuatu', type: 'bi'},
                        {name: 'Vatican City', type: 'it'},
                        {name: 'Venezuela', type: 'es'},
                        {name: 'Vietnam', type: 'vi'},
                        {name: 'Yemen', type: 'ar'},
                        {name: 'Zambia', type: 'en'},
                        {name: 'Zimbabwe', type: 'en'}
                        ],
                    dependsUpon: [{
                        id: 'vx_button',
                        values: [true]
