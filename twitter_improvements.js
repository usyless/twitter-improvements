    ...
    if (Settings.tweetObservingEnabled()) { // Run the extension
        const observerSettings = {subtree: true, childList: true},
            callbackMappings = {
                ...
                hide_notifications: [{s: 'a[aria-label="Notifications"]:not(.hidden)', f: Remove.Node}],
                hide_messages: [{s: 'a[aria-label="Direct Messages"]:not(.hidden)', f: Remove.Node}],
                hide_grok: [{s: 'a[aria-label="Grok"]:not(.hidden)', f: Remove.Node}],
                hide_jobs: [{s: 'a[aria-label="Jobs"]:not(.hidden)', f: Remove.Node}],
                hide_lists: [{s: 'a[aria-label="Lists"]:not(.hidden)', f: Remove.Node}],
                hide_communities: [{s: 'a[aria-label="Communities"]:not(.hidden)', f: Remove.Node}],
                hide_premium: [{s: 'a[aria-label="Premium"]:not(.hidden)', f: Remove.Node}, {s: 'aside[aria-label="Subscribe to Premium"]:not(.hidden)', f: Remove.Node}],
                hide_verified_orgs: [{s: 'a[aria-label="Verified Orgs"]:not(.hidden)', f: Remove.Node}],
